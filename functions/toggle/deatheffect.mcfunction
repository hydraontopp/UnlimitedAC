...
execute @s[tag=staffstatus,scores={dethtoggle=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6Death Effect §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
tellraw @a[tag=staffstatus,scores={has_xx=0,dethtoggle=1}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Experimental Features §7: §cNot Enabled §7|| §cThis module may not work!"}]}
#turn off
...
execute @s[tag=staffstatus,scores={dethtoggle=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6Death Effect §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
