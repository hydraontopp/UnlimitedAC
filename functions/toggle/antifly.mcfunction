...
execute @s[tag=staffstatus,scores={AFM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6Anti-Fly §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
tellraw @a[tag=staffstatus,scores={has_xx=0,AFM=1}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Experimental Features §7: §cNot Enabled §7|| §cThis module may false ban with elytra users!"}]}
#turn off
...
execute @s[tag=staffstatus,scores={AFM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6Anti-Fly §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
