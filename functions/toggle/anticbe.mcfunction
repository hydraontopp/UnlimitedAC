...
execute @s[tag=staffstatus,scores={ACM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6Anti-CBE §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
tellraw @a[tag=staffstatus,scores={has_xx=0,ACM=1}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Experimental Features §7: §cNot Enabled §7|| §cSome detections may not work!"}]}
#turn off
...
execute @s[tag=staffstatus,scores={ACM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6Anti-CBE §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
