...
execute @s[tag=staffstatus,scores={WBM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6World Border §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
tellraw @a[tag=staffstatus,scores={has_xx=0,WBM=1}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Experimental Features §7: §cNot Enabled §7|| §cThis module may not work!"}]}
#turn off
...
execute @s[tag=staffstatus,scores={WBM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6World Border §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
