...
execute @s[tag=staffstatus,scores={ICM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6Player Commands §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
tellraw @s[tag=staffstatus,scores={has_gt=0,ICM=1}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Gametest Features §7: §cNot Enabled §7|| §cPlayer Chat commands will not work"}]}
#turn off
...
execute @s[tag=staffstatus,scores={ICM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §6Player Commands §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
