...
#execute @s[tag=PermBan] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":" §¶§cis MOD Global Banned"}]}

#kick @s[tag=PermBan] §¶§eUnlimited ► You are MOD Global Banned! You may not join realms protected by MOD.
