#execute @e[type=command_block_minecart] ~~~ execute @a[r=10,scores={acmtoggle=1}] ~~~ function MOD/asset/cbeitemwarn
...
execute @s[scores={acmtoggle=1}] ~~~ kill @e[type=item,name="boat"]
