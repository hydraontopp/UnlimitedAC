#Fake staff flag
execute @s[scores={9NW0d9Nas=!7102}] ~~~ execute @s[tag=ownerstatus] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §6Fake Owner Protection : §bFlagged §d"},{"selector":"@s"},{"text":"§¶§b for unauthorized owner tag."}]}
