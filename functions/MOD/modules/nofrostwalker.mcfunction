...
execute @s[scores={nfmtoggle=1,feeten=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §6Anti Frostwalker §bremoved enchanted boots from §d"},{"selector":"@s"}]}
...
execute @s[scores={nfmtoggle=1,feeten=1,leathboots=1}] ~~~ replaceitem entity @s slot.armor.feet 0 leather_boots 1 0
