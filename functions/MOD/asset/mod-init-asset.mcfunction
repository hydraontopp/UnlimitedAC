...
scoreboard objectives add mod dummy mod
...
function MOD/asset/createdby
function MOD/asset/discord
function MOD/asset/version
...
function MOD/settings/ft_setup_init
function MOD/settings/ft_settings
...
event entity @a unlimited:test_experimental
tellraw @s[scores={has_xx=0}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Experimental Features §7: §cNot Enabled §7|| §cSome features may not work"}]}
tellraw @s[scores={has_xx=1}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Experimental Features §7: §2ENABLED"}]}
tellraw @s[scores={has_gt=1}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Gametest Features §7: §2ENABLED"}]}
tellraw @s[scores={has_gt=0}] {"rawtext":[{"text":"§¶§eUnlimited ► §6Gametest Features §7: §cNot Enabled §7|| §cPlayer Chat commands will not work"}]}
