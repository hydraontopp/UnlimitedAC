...
#Start unban window
execute @s[tag=staffstatus,scores={unban=1}] ~~~ scoreboard players set @s unbantimer 540
execute @s[tag=staffstatus,scores={unban=1}] ~~~ scoreboard players set @s hometp 5
execute @s[tag=staffstatus,scores={unban=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §d"},{"selector":"@s"},{"text":" §bhas §2OPENED a §6Unban Window"}]}
...
execute @s[tag=staffstatus,scores={unban=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited §¶§b► §d"},{"selector":"@s"},{"text":" §bhas §cCLOSED a §6Unban Window"}]}
