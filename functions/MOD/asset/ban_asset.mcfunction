...
execute @s[scores={BanCBE=1..}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":"§b §¶§cwas banned due to CBE exploits"}]}
execute @s[scores={BanWarn=1..}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":"§b §¶§cwas banned due to Reaching 3 Warnings"}]}
execute @s[scores={PermBan=1..}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":" §¶§cis MOD Global Banned and cannot be unbanned"}]}
execute @s[scores={Ban=1..}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":" §¶§cWas Banned by a OPERATOR"}]}
execute @s[scores={IIB=1..}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":"§b §¶§cwas banned due to Illegal Items"}]}
execute @s[scores={BanFly=1..}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":"§b §¶§cwas banned due to Fly Hacks"}]}
execute @s[scores={BanPhase=1..}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":"§b §¶§cwas banned due to Phase Hacks"}]}

execute @s[tag=!staffstatus,tag=PermBan] ~~~ function MOD/asset/ban_gameplay
execute @s[tag=!staffstatus,tag=BanCBE] ~~~ function MOD/asset/ban_gameplay
execute @s[tag=!staffstatus,tag=Ban] ~~~ function MOD/asset/ban_gameplay
execute @s[tag=!staffstatus,tag=illegalitemban] ~~~ function MOD/asset/ban_gameplay
execute @s[tag=!staffstatus,tag=BanFly] ~~~ function MOD/asset/ban_gameplay
execute @s[tag=!staffstatus,tag=BanPhase] ~~~ function MOD/asset/ban_gameplay
execute @s[tag=!staffstatus,scores={warn=3..}] ~~~ function MOD/asset/ban_gameplay
