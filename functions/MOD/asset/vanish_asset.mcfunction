...
execute @s[tag=staffstatus,scores={OPAM=1}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§eUnlimited §¶§b► Access §cDENIED§7! §6Anti OP Abuse §bdisables this command"}]}
#init vanish mode
execute @s[tag=staffstatus,scores={OPAM=0,vnsh=1}] ~~~ scoreboard players add @s vnsh 1
...
execute @s[tag=staffstatus,scores={OPAM=0,vnsh=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":" §¶§bHas §2ENABLED §6Vanish Mode"}]}
...
execute @s[tag=staffstatus,scores={OPAM=0,vnsh=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§eUnlimited ► §d"},{"selector":"@s"},{"text":" §¶§bHas §cDISABLED §6Vanish Mode"}]}
